...
export const FORMULES = [
  {
    ...
    supplement: 0,
    color: '#22C55E',
    features: ['Design responsive mobile', '3 pages incluses', 'Formulaire de contact', 'SEO de base', 'Livraison en 5 jours', 'Hébergement 1 an offert'],
  },
  {
    ...
    supplement: 20000,
    color: '#64748B',
    features: ['Tout Starter inclus', '6 pages incluses', 'Contenu administrable', 'Blog & galerie photos', 'Réseaux sociaux intégrés', 'Rapport de visite mensuel'],
  },
  {
    id: 'premium' as const,
    name: 'Premium',
    ...
    color: '#FF6B00',
    popular: true,
    features: ['Tout Standard inclus', '10 pages incluses', 'Animations & effets pro', 'Analytics avancés', 'Formulaires multi-étapes', 'Support prioritaire'],
  },
  {
    id: 'elite' as const,
    name: 'Elite',
    ...
    supplement: 100000,
    color: '#7C3AED',
    features: ['Tout Premium inclus', 'Pages illimitées', 'Modules au choix', 'Espace client/membre', 'Paiement en ligne', 'Maintenance 3 mois offerte'],
  },
]
